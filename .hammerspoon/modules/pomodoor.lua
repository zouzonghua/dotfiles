...
hs.hotkey.bind(modifiers, '9', 'pomodoor on', function() pom_enable() end)
hs.hotkey.bind(modifiers, '0', 'pomodoor off', function() pom_disable() end)
hs.hotkey.bind(modifiers, '-', 'pomodoor reset', function() pom_reset_work() end)
